...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-left justify-start gap-8 md:p-24 p-6 bg-base-100">
      ...
      <p>I am a fullstack developer located in <Anchor body='Oslo, Norway' href='https://goo.gl/maps/P4Xd2ajVkqvfqwHaA' title='Show on Google Maps'/>, I love building cool projects and I am currently getting better at backend</p>
      <div className='flex gap-4 flex-col md:flex-row '>
        <ContactButton className='btn-accent' url='mailto:theodor.learn@gmail.com' target="_blank">
          Send me an Email 🤩
        </ContactButton>
        <ContactButton url='https://www.linkedin.com/in/TheodorSTTH/' className='btn-primary' target="_blank">
        ...
        <ContactButton url="https://github.com/TheodorSTTH" target="_blank">
        ...
        <ContactButton url="/cv" target="_blank" className='btn btn-link'>
          See my CV
        </ContactButton>
      </div>
      <H2>My projects</H2>
